...
I'm not sure these startup times are apples to oranges. It seems kind of strange that Spring Boot takes so much longer. Maybe it's because it's started with Docker?
