...
NOTE: If you're unsure what OIDC and OAuth 2.0 are, see our https://developer.okta.com/blog/2019/10/21/illustrated-guide-to-oauth-and-oidc[Illustrated Guide to OAuth and OpenID Connect].
...
I also tested the startup time on a Linux laptop with 64 GB of RAM. I used the value the framework displays for startup time and did not make the "initialization complete" adjustment.
...
NOTE: If you disagree with these numbers and think X framework should be faster, I encourage you to clone [the repo](https://github.com/oktadev/native-java-examples) and run these tests yourself. If you get faster startup times for Spring Boot, do you get faster startup times for Micronaut and Quarkus too?
