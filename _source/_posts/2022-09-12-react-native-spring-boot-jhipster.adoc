...
// todo: use HTML to arrange these in a single row
image::{% asset_path blog/react-native-jhipster/react-native-web.png %}[alt=React Native web,width=800,align=center]

image::{% asset_path blog/react-native-jhipster/react-native-web-photos.png %}[alt=React Native photos list,width=800,align=center]

image::{% asset_path blog/react-native-jhipster/react-native-web-photo.png %}[alt=React Native photo with Josh,width=800,align=center]
...
// todo: arrange these images in a single row
