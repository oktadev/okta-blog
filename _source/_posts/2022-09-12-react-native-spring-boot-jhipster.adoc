...
For the Android emulator to communicate with your API and Keycloak, you'll need to add some port mappings. The command worked if `8080` and `9080` are printed to your terminal.
