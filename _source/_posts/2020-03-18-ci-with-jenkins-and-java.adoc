...
If you don't have an Okta developer account already, execute the https://github.com/oktadeveloper/okta-maven-plugin[Okta Maven Plugin] to create one (for free!) and configure the authentication in the app:
