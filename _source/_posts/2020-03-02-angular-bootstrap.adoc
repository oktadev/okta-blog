...
type: conversion
changelog:
  - 2021-04-06: Changed Okta OIDC app creation instructions to use the Okta CLI. See changes in [okta-blog#670](https://github.com/oktadeveloper/okta-blog/pull/670).
...
Start your Spring Boot app by navigating to the `notes-api` directory and running Gradle's `bootRun` task.
