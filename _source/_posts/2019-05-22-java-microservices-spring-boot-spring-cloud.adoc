...
type: conversion
changelog:
  - 2021-03-29: Streamlined Okta app setup with the Okta CLI. You can see the example app changes in [java-microservices-examples#18](https://github.com/oktadeveloper/java-microservices-examples/pull/18); changes to this post can be viewed in [okta-blog#623](https://github.com/oktadeveloper/okta-blog/pull/623).
...
{% include setup/cli.md type="web" framework="Okta Spring Boot Starter" adoc="true" %}
