...
NOTE: If you'd like to learn more about Vaadin and Okta, please join Marcus and me for a https://v.vaadin.com/vaadin-webinar-web-application-security[webinar on web app security on November 17, 2020].
