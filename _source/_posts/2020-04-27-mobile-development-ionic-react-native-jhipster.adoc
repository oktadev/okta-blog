...
As a web developer, I love using the technologies I know and love to create mobile apps. In this screencast, I show you how to use JHipster and its Ionic and React Native modules to create a health tracking application.
