...
> Abstract on SSF filled out by E. Dunham. Also please replace link to podcast.
> Link to blog pointing to podcast on SSF with Jamf
...
> Abstract on UL filled out by Semona Igama
> Link to blog post on UL
> Invitation for ISVs to contact us at dev-advocacy@okta.com if interested in testing w/Okta in a pilot program
