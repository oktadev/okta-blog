...
npm run ci:e2e:prepare # start dependent docker images
...
The native binary starts in just over 500ms (583ms) on my 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM.
