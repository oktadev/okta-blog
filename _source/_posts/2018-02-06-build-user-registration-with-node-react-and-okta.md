...
* Sep 18, 2019: Updated to use the latest versions of dependencies. You can see the example app changes in [okta-node-react-registration-example#1]; changes to this post can be viewed in [okta.github.io#2672](https://github.com/oktadeveloper/okta.github.io/pull/2672).
