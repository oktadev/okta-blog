...
This is the readme file that you can see in the Git repository for this project.
...
Finally, add a new file called `_layout_aunthenticated.11ty.js`.  Add the code below to it.
