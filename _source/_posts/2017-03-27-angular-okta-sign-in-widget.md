...
* Aug 27, 2020: Updated to use Angular 10 and Okta Sign-In Widget 4.4.0. See the code changes in [okta-angular-sign-in-widget-example#19](https://github.com/oktadeveloper/okta-angular-sign-in-widget-example/pull/19) and the article changes in [okta-blog#2028](https://github.com/oktadeveloper/okta-blog/pull/399).
