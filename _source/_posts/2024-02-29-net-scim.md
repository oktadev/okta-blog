...
Log in to your [Okta Integrator Account](https://developer.okta.com/login/) that you created previously.  
...
Log in to your Okta Integrator Account. Ensure you're in the Admin Console — when you're in the Admin Console, the URL will be "dev-youraccountid-admin.okta.com". In the sidebar, select **Applications** > **Applications**, and press the **Browse App Catalog** button. 
