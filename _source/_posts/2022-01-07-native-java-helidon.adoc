...
====
The numbers may look higher the expected, but, in Helidon MP you've got a fully functional CDI container and full MicroProfile support, unlike other competitors. If still require ultimate performance, you should try Helidon SE, which is a fully reactive "magic free" flavor of Helidon, designed for environments working under maximal pressure.
====
