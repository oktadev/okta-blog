...
https://www.manning.com/books/secure-by-design[image:{% asset_path 'blog/security-patterns-microservices/secure-by-design.png' %}[alt=Secure by Design Book,align=center,role="pull-right img-200px"]]
