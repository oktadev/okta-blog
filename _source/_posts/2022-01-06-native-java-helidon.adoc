...
changelog:
- 2022-04-16: Updated to use Helidon 2.5.0. See this post's changes in [okta-blog#1143](https://github.com/oktadev/okta-blog/pull/1143) and the example app changes in [native-java-examples#23](https://github.com/oktadev/native-java-examples/pull/23).
