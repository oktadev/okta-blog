...
_These numbers are from a 2021 MacBook Pro with an M1 Max processor and 64 GB of RAM. I think it's important to note that my WiFi connection was 48.2 Mbps down and 9.71 Mbps up (according to the Speedtest app)._

////
Helidon: (23 + 20 + 23 + 30 + 19) / 5 = 23
...
|Helidon | `./helidon/target/helidon` | 23
|Micronaut | `./micronaut/target/app` | 18.4
|Quarkus | `./quarkus/target/quarkus-1.0.0-SNAPSHOT-runner` | 11.6
|Spring Boot | `./spring-boot/target/demo` | 36
|===
