...
While it works, there are several downsides even in midterm:
...
## Testing Spring Boot Controller layer 
 
As with any genuine web service, my application depends on external services which need provisioning before the application starts.
