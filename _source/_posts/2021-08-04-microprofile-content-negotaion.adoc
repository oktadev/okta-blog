...
image: blog/microprofile-content-negotaion/social.png
type: awareness
---
...
One of my favorite examples of using the User-Agent for content negotiation is adding descriptive help to a REST server. I learned this trick from the https://github.com/spring-io/start.spring.io[Spring Initializer project], which returns different results if you use HTTPie or curl: `http https://start.spring.io`.
