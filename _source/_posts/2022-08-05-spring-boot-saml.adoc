...
changelog:
- 2022-11-03: Updated to remove `permitAll()` for favicon. You can see the changes in this post in [okta-blog#900](https://github.com/oktadev/okta-blog/pull/900) and the example app changes in [okta-spring-boot-saml-example#23](https://github.com/oktadev/okta-spring-boot-saml-example/pull/23).
---
:page-liquid:
:toc: macro
:experimental:
