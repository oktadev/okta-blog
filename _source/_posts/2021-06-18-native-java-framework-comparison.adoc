...
[source,shell]
----
# Downloaded and expanded graalvm-ce-java17-darwin-aarch64-dev.tar.gz from https://github.com/graalvm/graalvm-ce-dev-builds/releases/download/22.2.0-dev-20220326_0133/graalvm-ce-java17-darwin-aarch64-dev.tar.gz
mv ~/Downloads/graalvm-ce-java17-22.2.0-dev/Contents/Home ~/.sdkman/candidates/java/22.2.0.dev.r17-grl
sudo xattr -r -d com.apple.quarantine ~/.sdkman/candidates/java/22.2.0.dev.r17-grl
sdk default java 22.2.0.dev.r17-grl
----
...
////
Micronaut: (20 + 18 + 17 + 19 + 18) / 5 = 18.4
Quarkus: (13 + 10 + 11 + 12 + 12) / 5 = 11.6
Spring Boot: (36 + 36 + 38 + 36 + 34) / 5 = 36
////
...
|Micronaut | `./target/app` | 18.4
|Quarkus | `./target/quarkus-1.0.0-SNAPSHOT-runner` | 11.6
|Spring Boot | `./target/demo` | 36
|===
...
|Micronaut | `app` | 41 | 58 | 68
|Quarkus | `runner` | 32 | 44 | 46
|Spring Boot | `demo` | 63 | 75 | 75
|===
