...
changelog:
- 2022-04-16: Updated to use Micronaut 3.4.2, Quarkus 2.8.0, Spring Boot 2.6.6, and Spring Native 0.11.4. See this post's changes in [okta-blog#1142](https://github.com/oktadev/okta-blog/pull/1142) and the example app changes in [native-java-examples#22](https://github.com/oktadev/native-java-examples/pull/22).
