...
changelog:
- 2022-04-16: Updated to use Micronaut 3.4.2, Quarkus 2.8.0, and Spring Native 0.11.4. See this post's changes in [okta-blog#1123](https://github.com/oktadev/okta-blog/pull/1123) and the example app changes in [native-java-examples#16](https://github.com/oktadev/native-java-examples/pull/16).
- 2022-03-31: Updated to use GraalVM 22.0, Micronaut 3.4.1, Quarkus 2.7.5, Spring Boot 2.6.6, and Spring Native 0.11.3. See this post's changes in [okta-blog#1123](https://github.com/oktadev/okta-blog/pull/1123) and the example app changes in [native-java-examples#16](https://github.com/oktadev/native-java-examples/pull/16).
...
date: Thu, 31 Mar 2022 23:02:47 GMT
...
17:13:26.624 [main] INFO  io.micronaut.runtime.Micronaut - Startup completed in 32ms. Server Running: http://localhost:8080
----
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 55 seconds.
...
2022-03-31 17:27:29,574 INFO  [io.quarkus] (main) quarkus 1.0.0-SNAPSHOT native (powered by Quarkus 2.7.5.Final) started in 0.019s. Listening on: http://0.0.0.0:8080
2022-03-31 17:27:29,575 INFO  [io.quarkus] (main) Profile prod activated.
2022-03-31 17:27:29,575 INFO  [io.quarkus] (main) Installed features: [cdi, reactive-routes, resteasy-reactive, security, smallrye-context-propagation, smallrye-jwt, vertx]
----
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 2 min. 55 s.

Start it with `./target/demo`:

----
$ ./target/demo
2022-03-31 17:42:36.378  INFO 99149 --- [           main] o.s.nativex.NativeListener               : AOT mode enabled
...
( ( )\___ | '_ | '_| | '_ \/ _` | \ \ \ \
 ...
 :: Spring Boot ::                (v2.6.5)
...
2022-03-31 17:42:36.418  INFO 99149 --- [           main] o.s.b.w.embedded.tomcat.TomcatWebServer  : Tomcat started on port(s): 8080 (http) with context path ''
2022-03-31 17:42:36.418  INFO 99149 --- [           main] com.okta.rest.Application                : Started Application in 0.056 seconds (JVM running for 0.058)
----
...
_These numbers are from a 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM. I think it's important to note that my WiFi connection was 444 Mbps down and 492 Mbps up (according to the Speedtest app)._

////
Micronaut: (35 + 35 + 30 + 34 + 34) / 5 = 33.6
Quarkus: (16 + 17 + 16 + 16 + 16) / 5 = 16.2
Spring Boot: (53 + 55 + 56 + 55 + 54) / 5 = 54.6
////
...
|Micronaut | `./target/app` | 33.6
|Quarkus | `./target/quarkus-1.0.0-SNAPSHOT-runner` | 16.2
|Spring Boot | `./target/demo` | 54.6
|===
...
|Quarkus | `runner` | 20 | 31 | 33
|Spring Boot | `demo` | 46 | 56 | 57
|===
