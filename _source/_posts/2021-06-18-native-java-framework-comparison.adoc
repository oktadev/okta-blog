...
changelog:
- 2022-06-05: Updated to use Micronaut 3.5.1, Quarkus 2.9.2, Spring Boot 2.7.0, and Spring Native 0.12.0. See this post's changes in [okta-blog#1185](https://github.com/oktadev/okta-blog/pull/1185) and the example app changes in [native-java-examples#25](https://github.com/oktadev/native-java-examples/pull/28).
