...
type: conversion
changelog:
- 2021-10-06: Updated to use Micronaut 3.0.3, Quarkus 2.3.0.Final, and Spring Boot 2.5.4. Also changed Spring Boot to create binary instead of Docker image for performance comparisons. See this post's changes in [okta-blog#913](https://github.com/oktadev/okta-blog/pull/913) and the example app changes in [native-java-examples#7](https://github.com/oktadev/native-java-examples/pull/7).
...
_These numbers are from a 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM. I think it's important to note that my WiFi connection was 211 Mbps down and 176 Mbps up (according to the Speedtest app)._
...
|Micronaut | `./target/app` | 22.2
|Quarkus | `./target/quarkus-1.0.0-SNAPSHOT-runner` | 17.4
|Spring Boot | `./target/demo` | 647.2
|===
