...
changelog:
- 2022-04-18: Updated to use Micronaut 3.4.2, Quarkus 2.8.0, Spring Boot 2.6.6, and Spring Native 0.11.4. See this post's changes in [okta-blog#1142](https://github.com/oktadev/okta-blog/pull/1142) and the example app changes in [native-java-examples#22](https://github.com/oktadev/native-java-examples/pull/22).
...
date: Sun, 17 Apr 2022 03:56:46 GMT
...
This command will take a few minutes to complete. My 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM took 1 min. 13 s. to finish.
...
22:24:07.707 [main] INFO  io.micronaut.runtime.Micronaut - Startup completed in 26ms. Server Running: http://localhost:8080
----

You can see it starts pretty darn quick (26ms)! Test it with HTTPie and an access token. You may have to generate a new JWT with https://oidcdebugger.com[oidcdebugger.com] if yours has expired.
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 1 min. 10 s.
...
2022-04-16 22:28:47,766 INFO  [io.quarkus] (main) quarkus 1.0.0-SNAPSHOT native (powered by Quarkus 2.8.0.Final) started in 0.016s. Listening on: http://0.0.0.0:8080
2022-04-16 22:28:47,768 INFO  [io.quarkus] (main) Profile prod activated.
2022-04-16 22:28:47,768 INFO  [io.quarkus] (main) Installed features: [cdi, reactive-routes, resteasy-reactive, security, smallrye-context-propagation, smallrye-jwt, vertx]
----
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 3 min. 4 s.

Start it with `./target/demo`:

----
$ ./target/demo
2022-04-16 22:34:12.285  INFO 78615 --- [           main] o.s.nativex.NativeListener               : AOT mode enabled
...
( ( )\___ | '_ | '_| | '_ \/ _` | \ \ \ \
 ...
 :: Spring Boot ::                (v2.6.6)
...
2022-04-16 22:34:12.329  INFO 78615 --- [           main] o.s.b.w.embedded.tomcat.TomcatWebServer  : Tomcat started on port(s): 8080 (http) with context path ''
2022-04-16 22:34:12.329  INFO 78615 --- [           main] com.okta.rest.Application                : Started Application in 0.058 seconds (JVM running for 0.06)
----
...
|Micronaut | `./target/app` | 27.8
|Quarkus | `./target/quarkus-1.0.0-SNAPSHOT-runner` | 17.2
|Spring Boot | `./target/demo` | 62.6
|===
