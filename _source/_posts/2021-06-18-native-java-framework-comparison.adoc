...
changelog:
- 2022-03-31: Updated to use GraalVM 22.0, Micronaut 3.4.1, Quarkus 2.7.5, Spring Boot 2.6.6, and Spring Native 0.11.3. See this post's changes in [okta-blog#1016](https://github.com/oktadev/okta-blog/pull/1016) and the example app changes in [native-java-examples#11](https://github.com/oktadev/native-java-examples/pull/11).
