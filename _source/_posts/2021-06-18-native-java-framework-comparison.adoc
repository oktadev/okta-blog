...
type: conversion
changelog:
- 2021-10-07: Updated to use Micronaut 3.0.3, Quarkus 2.3.0.Final, and Spring Boot 2.5.4. Changed Spring Boot to create binary instead of Docker image and updated performance stats. See this post's changes in [okta-blog#913](https://github.com/oktadev/okta-blog/pull/913) and the example app changes in [native-java-examples#7](https://github.com/oktadev/native-java-examples/pull/7).
...
This command will take a few minutes to complete. My 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM took 1 min. 25 s. to finish.
...
23:11:58.796 [main] INFO  io.micronaut.runtime.Micronaut - Startup completed in 22ms. Server Running: http://localhost:8080
----
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 1 min. 8 s.
...
2021-10-06 23:19:46,957 INFO  [io.quarkus] (main) quarkus 1.0.0-SNAPSHOT native (powered by Quarkus 2.3.0.Final) started in 0.022s. Listening on: http://0.0.0.0:8080
2021-10-06 23:19:46,957 INFO  [io.quarkus] (main) Profile prod activated.
2021-10-06 23:19:46,957 INFO  [io.quarkus] (main) Installed features: [cdi, reactive-routes, resteasy, security, smallrye-context-propagation, smallrye-jwt, vertx]
----

Supersonic Subatomic Java (in 22ms)! Test it with HTTPie and an access token.
...
The native compilation step will take a bit to complete. On my 2019 MacBook Pro, it took 3 min. 7 s.

Start it with `./target/demo`:

----
$ ./target/demo
2021-10-06 23:33:20.894  INFO 35991 --- [           main] o.s.nativex.NativeListener               : This application is bootstrapped with code generated with Spring AOT
...
( ( )\___ | '_ | '_| | '_ \/ _` | \ \ \ \
 ...
 :: Spring Boot ::                (v2.5.5)
...
2021-10-06 23:33:21.785  INFO 35991 --- [           main] o.s.b.w.embedded.tomcat.TomcatWebServer  : Tomcat started on port(s): 8080 (http) with context path ''
2021-10-06 23:33:21.788  INFO 35991 --- [           main] com.okta.rest.Application                : Started Application in 1.136 seconds (JVM running for 1.138)
----
...
_These numbers are from a 2019 MacBook Pro with a 2.4 GHz 8-Core Intel Core i9 processor and 64 GB of RAM. I think it's important to note that my WiFi connection was 33 Mbps down and 10 Mbps up (according to the Speedtest app)._
...
|Micronaut | `./target/app` | 22.4
|Quarkus | `./target/quarkus-1.0.0-SNAPSHOT-runner` | 21
|Spring Boot | `./target/demo` | 648.8
|===
...
// (88 + 90 + 100 + 122 + 86) / 5 = 97.2ms
This improved the startup time by over 500ms (97.2ms on average).
...
function drawChart() {
  var data = google.visualization.arrayToDataTable([
    ['Framework', 'Memory (MB) usage', { role: 'style' }],
    ['Micronaut', 62, 'blue'],
    ['Quarkus', 35, 'red'],
