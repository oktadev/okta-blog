...
type: conversion
changelog:
- 2021-09-15: Updated to use Micronaut 3.0.1, Quarkus 2.2.2.Final, and Spring Boot 2.5.4. See changes in https://github.com/oktadev/okta-blog/pull/885[okta-blog#885].
---
:page-liquid:
:toc: macro
:experimental:
