...
In the previous two installments of this OpenID Connect (OIDC) series, we dug deep into the [OIDC flow types](/blog/2017/07/25/oidc-primer-part-1) and saw [OIDC in action](/blog/2017/07/25/oidc-primer-part-2) using a playground found at: [https://okta-oidc-fun.herokuapp.com/](https://okta-oidc-fun.herokuapp.com/).
...
The whole series is live now. Part 1 is [here](/blog/2017/07/25/oidc-primer-part-1). Part 2 is [here](/blog/2017/07/25/oidc-primer-part-2). If you're looking for other security-focused articles, you may want to check out our new [security site](https://sec.okta.com), where we're publishing lots of other in-depth security pieces.
