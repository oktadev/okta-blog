...
The only exception would be for a security patch: then it's good for us to break the user code, if necessary, as he also needs to fix his own code. But that's very specific because we are a code generator, and I hope we can remove this as much as possible (I'd like to generate less code, and give more responsibilities to the JHipster libraries, typically because they solve this kind of issue).
...
How do you succeed at open source releases? I think it's important to test your libraries as much as you can. If you have a lot of projects depending on yours, join https://opencollective.com/[OpenCollective] and ask for donations. Encourage other developers to join your project and help out! Mentor developers and enter bugs and enhancements in your issuer tracker so folks know what you need help with. Don't be afraid to increment your minor and major release numbers when you're creating upgrade pain.
