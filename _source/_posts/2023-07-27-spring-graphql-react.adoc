...
Now let's create a Single Page Application (SPA) to consume the GraphQL API with React and Next.js.

. describe client application, MUI, Next, TypeScript, Container pattern
...
. Explain layout component and theme required for next.js font to work
