...
Copy the auth0 domain and the client Id, and update the file 'src/.env.local' with the following properties:
...
Add the `@auth0/auth0-react` dependency to the `package.json` file:
