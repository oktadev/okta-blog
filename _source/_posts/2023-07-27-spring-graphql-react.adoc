...
Create the folder `src/app/services` and add the file `base.tsx` with the following code:
...
Add the file `src/app/services/companies.tsx` with the following content:
...
Create the folder `src/app/hooks` and add the file `useAsync.tsx` with the following content:
...
Create the folder `src/app/components/companies` and add the file `CompanyTable.tsx` with the following content:
...
Add the file `src/app/components/companies/CompanyTableContainer.tsx` with the following content:
...
Create the file `src/app/layout/WideLayout.tsx` with the following content:
...
== Add Auth0 Login and Resource Server Security
