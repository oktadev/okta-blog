...
type: conversion
changelog: 
  - 2021-12-08: Updated GitHub repo and blog post with dependency updates. You can see the changes in the [example app on GitHub](https://github.com/oktadev/okta-node-express-typescript-vue-example/pull/11). Changes to this article can be viewed in [oktadev/okta-blog#???](https://github.com/oktadev/okta-blog/pull/???).
---
