...
**Tip:** This tutorial is part of our series on how to integrate Okta with popular Infrastructure as a Code solutions. If you're not into Chef, check out our [Ansible](/blog/2021/??/??/okta-ansible), [Puppet](/blog/2021/??/??/okta-puppet), and [Terraform](/blog/2020/04/24/okta-terraform-automate-identity-and-infrastructure) tutorials.
...
To setup the ASA agent, enter `sft enroll` and follow the instructions in the screen.
