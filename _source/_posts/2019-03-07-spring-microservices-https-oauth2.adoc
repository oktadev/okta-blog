...
public class SchoolController {
    ...
    public ResponseEntity<List<TeachingClassDto>> listClasses(
        ...
        // WARNING: This is example code that should not be used in production.
        // In production, it's recommended you use a RestTemplateFactory
        // to give each user their own instance. With this code, an attacker
        // can exploit a race condition and obtain the victim's authorization token.
