...
type: conversion
changelog:
- 2022-08-12: Added link to [CI/CD Java Microservices with CircleCI and Spinnaker](/blog/2022/08/12/ci-cd-circleci-spinnaker-microservices) as a downstream blog post. Changes can be viewed in [okta-blog#857](https://github.com/oktadev/okta-blog/pull/857).
