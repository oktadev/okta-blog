...
TIP: I gave a https://oktane20.com/agenda#566[talk on Security Patterns for Microservice Architectures at Oktane20] on April 2, 2020. You can https://oktane20.com/register[register] and watch it for free until April 10.
