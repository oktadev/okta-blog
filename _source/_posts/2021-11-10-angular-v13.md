...
And a container component that handles the dynamic creation of the component. I simplified the code snipped to focus on the v13 change. Stay tuned for an upcoming post on a walkthrough to create this application.
