...
* Dec 19, 2018: Updated to use Okta Spring Boot Starter 1.0.0. You can see the changes to this post in https://github.com/oktadeveloper/okta.github.io/pull/2590[okta.github.io#2590].
