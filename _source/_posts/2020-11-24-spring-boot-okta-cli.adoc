---
layout: blog_post
title: "Spring Boot and Okta in 2 Minutes with the Okta CLI"
author: matt-raible
by: advocate
communities: [java]
...
If you use another browser, or an incognito window, you'll be prompted to sign in.

image::{% asset_path 'blog/okta-cli-spring-boot/okta-login.png' %}[alt=Okta Login,width=800,align=center]

If you open `src/main/java/com/example/sample/Application.java`, you'll see the Java code that's used to render your name. You might appreciate how easy Spring Security makes authentication with OpenID Connect.
...
I hope you've enjoyed this brief intro to the Okta CLI. It's a tool for developers to make their lives easier. If you have any suggestions for improvement, please add an issuer to our https://github.com/okta/okta-cli[okta/okta-cli] repository.
