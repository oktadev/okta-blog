...
Click on **Create** and copy the _Client ID_ and _Client Secret_, click **Continue**. Then update the `application.yml` with the following properties:
