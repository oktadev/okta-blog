...
3. Download the files from https://drive.google.com/drive/folders/11W-cjmkTztmnGgJCsJRtE395Iji6JX53?usp=share_link and make sure the files are saved in a folder on your drive (not within any folders) and you are mounting the files from the correct account. Make sure the name of the folder is 'oktanaut'.
