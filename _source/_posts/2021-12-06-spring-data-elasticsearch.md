...
_The entity search repository_
...
You can find the Blog application code of this tutorial in [GitHub](https://github.com/oktadev/okta-spring-data-elasticsearch-example.).
