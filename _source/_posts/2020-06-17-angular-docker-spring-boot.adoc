...
image: blog/angular-docker/angular-spring-boot-docker-hug.png
type: conversion
---
:toc: macro
:page-liquid:
...
image::{% asset_path 'blog/angular-docker/keyword-planner-angular-results.png.png' %}[alt=Keyword Planner results,width=700,align=center]
