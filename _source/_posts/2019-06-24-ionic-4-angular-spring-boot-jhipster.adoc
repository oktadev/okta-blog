...
[source,shell]
----
npm i -g ionic@5.4.4 yo generator-jhipster-ionic@4.2.1
yo jhipster-ionic
----
...
* Oct 30, 2019: Updated to use JHipster 6.4.1 and Ionic for JHipster 4.3.0. Changes to this post can be viewed in https://github.com/oktadeveloper/okta-blog/pull/2869[okta-blog#28]. Updates to the example application are in https://github.com/oktadeveloper/okta-ionic4-jhipster-example/pull/7[okta-ionic4-jhipster-example#7].
