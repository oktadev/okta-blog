...
* May 20, 2020: Updated to remove `/implicit` from redirect URIs since auth code flow is used. Changes to this post can be viewed in https://github.com/oktadeveloper/okta-blog/pull/302[okta-blog#302]. Updates to the example application are in https://github.com/oktadeveloper/okta-ionic4-jhipster-example/pull/10[okta-ionic4-jhipster-example#10].
